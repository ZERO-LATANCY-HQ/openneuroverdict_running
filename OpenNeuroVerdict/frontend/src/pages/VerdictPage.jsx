  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: "32px 40px", animation: "fadeIn 0.4s ease" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24, paddingBottom: 16, borderBottom: "1px solid #1e2433" }}>
        ...
        <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 14, color: "#e6edf3", fontWeight: 700 }}>Analysis Report</span>
      ...
      <Reveal>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ background: "#0d1117", border: "1px solid #1e2433", borderRadius: 8, padding: "24px 28px" }}>
            <div style={{ fontSize: 9, color: "#484f58", letterSpacing: 2, fontFamily: "monospace", marginBottom: 16, textTransform: "uppercase" }}>Final Decision</div>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
              ...
              <div>
                <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 24, fontWeight: 700, color: decisionColor, letterSpacing: 2 }}>
          ...
          {/* Fairness card */}
          <div style={{ background: "#0d1117", border: "1px solid #1e2433", borderRadius: 8, padding: "24px 28px" }}>
            <div style={{ fontSize: 9, color: "#484f58", letterSpacing: 2, fontFamily: "monospace", marginBottom: 16, textTransform: "uppercase" }}>Fairness Audit</div>
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
              <div style={{
                width: 52, height: 52, borderRadius: 10,
              ...
              <div>
                <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 18, fontWeight: 700, color: "#e6edf3" }}>
      ...
      <Reveal delay={100}>
        <div style={{ background: "#0d1117", border: "1px solid #1e2433", borderRadius: 8, padding: "20px 24px", marginBottom: 16 }}>
          <div style={{ fontSize: 9, color: "#484f58", letterSpacing: 2, fontFamily: "monospace", marginBottom: 16, textTransform: "uppercase" }}>Agent Votes</div>
              ...
              return (
                <div key={i} style={{ background: "#080c14", border: "1px solid #1e2433", borderRadius: 6, padding: "12px 14px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: 9, color: "#8b949e", fontFamily: "monospace", letterSpacing: 0.5 }}>{agent.name}</span>
                  </div>
                  <div style={{ fontSize: 10, fontFamily: "monospace", fontWeight: 700, color: vote ? "#34d399" : "#f87171", marginBottom: 6 }}>
                  ...
                  <div style={{ fontSize: 9, color: "#484f58", fontFamily: "monospace", marginTop: 4 }}>{Math.round(m.confidence * 100)}%</div>
                </div>
              );
            })}
          </div>
      ...
      <Reveal delay={200}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
          <div style={{ background: "#0d1117", border: "1px solid #1e2433", borderRadius: 8, padding: "20px 24px" }}>
            <div style={{ fontSize: 9, color: "#484f58", letterSpacing: 2, fontFamily: "monospace", marginBottom: 14, textTransform: "uppercase" }}>Key Reasons</div>
            {(Array.isArray(verdict.reasons) ? verdict.reasons : [verdict.reasons]).map((r, i) => (
              <div key={i} style={{ display: "flex", gap: 10, marginBottom: 10, fontSize: 12, color: "#9ca3af", lineHeight: 1.6, fontFamily: "system-ui, sans-serif" }}>
                <span style={{ color: "#34d399", flexShrink: 0, marginTop: 1 }}>→</span> {r}
              </div>
            ))}
          </div>
          <div style={{ background: "#0d1117", border: "1px solid #1e2433", borderRadius: 8, padding: "20px 24px" }}>
            <div style={{ fontSize: 9, color: "#484f58", letterSpacing: 2, fontFamily: "monospace", marginBottom: 14, textTransform: "uppercase" }}>Counter Argument</div>
            <div style={{ fontSize: 12, color: "#9ca3af", lineHeight: 1.7, fontFamily: "system-ui, sans-serif" }}>{verdict.why_not}</div>
          </div>
        </div>
      </Reveal>
      ...
      {fairness.flags?.length > 0 && (
        <Reveal delay={300}>
          <div style={{ background: "#0d1117", border: "1px solid #f8717122", borderRadius: 8, padding: "16px 24px" }}>
            <div style={{ fontSize: 9, color: "#f87171", letterSpacing: 2, fontFamily: "monospace", marginBottom: 12, textTransform: "uppercase" }}>Bias Flags</div>
            {fairness.flags.map((f, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6, fontSize: 11, color: "#9ca3af", fontFamily: "monospace" }}>
